...
namespace BlogLab.Identity
{
    ...
    {
        // Using Identity framework, the code below would not have needed
        // but since we used Dapper and are hooking into the net core framework, we have to handle it ourselves
        ...
        {
            // ASP net core identity will hash the password
